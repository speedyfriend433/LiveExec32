...
- (id)initWithPayee:(id)guest_arg0 payer:(id)guest_arg1 currencyAmount:(id)guest_arg2 paymentMethod:(id)guest_arg3 note:(id)guest_arg4 status:(int)guest_arg5 feeAmount:(id)guest_arg6 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_arg0 = [guest_arg0 host_self]; 
...
- (id)initWithPayee:(id)guest_arg0 payer:(id)guest_arg1 currencyAmount:(id)guest_arg2 paymentMethod:(id)guest_arg3 note:(id)guest_arg4 status:(int)guest_arg5 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_arg0 = [guest_arg0 host_self]; 
