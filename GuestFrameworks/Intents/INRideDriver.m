...
- (id)initWithPersonHandle:(id)guest_arg0 nameComponents:(id)guest_arg1 displayName:(id)guest_arg2 image:(id)guest_arg3 contactIdentifier:(id)guest_arg4 customIdentifier:(id)guest_arg5 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
...
- (id)initWithPersonHandle:(id)guest_arg0 nameComponents:(id)guest_arg1 displayName:(id)guest_arg2 image:(id)guest_arg3 rating:(id)guest_arg4 phoneNumber:(id)guest_arg5 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_arg0 = [guest_arg0 host_self]; 
...
- (id)initWithHandle:(id)guest_arg0 nameComponents:(id)guest_arg1 image:(id)guest_arg2 rating:(id)guest_arg3 phoneNumber:(id)guest_arg4 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_arg0 = [guest_arg0 host_self]; 
...
- (id)initWithPhoneNumber:(id)guest_arg0 nameComponents:(id)guest_arg1 displayName:(id)guest_arg2 image:(id)guest_arg3 rating:(id)guest_arg4 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_arg0 = [guest_arg0 host_self]; 
...
- (id)initWithHandle:(id)guest_arg0 displayName:(id)guest_arg1 image:(id)guest_arg2 rating:(id)guest_arg3 phoneNumber:(id)guest_arg4 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_arg0 = [guest_arg0 host_self]; 
