...
- (void)setTopology:(id)guest_arg0 {
...
- (id)initWithName:(id)guest_arg0 indexBuffer:(id)guest_arg1 indexCount:(unsigned int)guest_arg2 indexType:(unsigned int)guest_arg3 geometryType:(int)guest_arg4 material:(id)guest_arg5 topology:(id)guest_arg6 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_arg0 = [guest_arg0 host_self]; 
...
- (id)initWithName:(id)guest_arg0 indexBuffer:(id)guest_arg1 indexCount:(unsigned int)guest_arg2 indexType:(unsigned int)guest_arg3 geometryType:(int)guest_arg4 material:(id)guest_arg5 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_arg0 = [guest_arg0 host_self]; 
...
- (id)initWithMDLSubmesh:(id)guest_arg0 indexType:(unsigned int)guest_arg1 geometryType:(int)guest_arg2 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_arg0 = [guest_arg0 host_self]; 
...
- (id)initWithIndexBuffer:(id)guest_arg0 indexCount:(unsigned int)guest_arg1 indexType:(unsigned int)guest_arg2 geometryType:(int)guest_arg3 material:(id)guest_arg4 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_arg0 = [guest_arg0 host_self]; 
...
- (id)indexBufferAsIndexType:(unsigned int)guest_arg0 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
