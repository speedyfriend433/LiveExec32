...
- (id)initWithColorGradientFrom:(CGColor *)guest_arg0 toColor:(CGColor *)guest_arg1 name:(id)guest_arg2 {
  ...
  uint64_t host_ret = LC32InvokeHostSelector(self.host_self, _host_cmd, /* parameterToBePassed: unhandled type CGColor * */, /* parameterToBePassed: unhandled type CGColor * */, host_arg2);
...
- (id)initWithColorTemperatureGradientFrom:(float)guest_arg0 toColorTemperature:(float)guest_arg1 name:(id)guest_arg2 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
