...
- (id)initWithRoundingMode:(unsigned int)guest_arg0 scale:(short)guest_arg1 raiseOnExactness:(char)guest_arg2 raiseOnOverflow:(char)guest_arg3 raiseOnUnderflow:(char)guest_arg4 raiseOnDivideByZero:(char)guest_arg5 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
...
- (id)exceptionDuringOperation:(SEL)guest_arg0 error:(unsigned int)guest_arg1 leftOperand:(id)guest_arg2 rightOperand:(id)guest_arg3 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
...
+ (id)decimalNumberHandlerWithRoundingMode:(unsigned int)guest_arg0 scale:(short)guest_arg1 raiseOnExactness:(char)guest_arg2 raiseOnOverflow:(char)guest_arg3 raiseOnUnderflow:(char)guest_arg4 raiseOnDivideByZero:(char)guest_arg5 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_arg0 = (uint64_t)guest_arg0; 
