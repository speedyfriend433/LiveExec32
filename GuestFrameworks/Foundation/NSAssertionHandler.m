...
- (void)handleFailureInMethod:(SEL)guest_arg0 object:(id)guest_arg1 file:(id)guest_arg2 lineNumber:(int)guest_arg3 description:(id)guest_arg4 {
...
- (void)handleFailureInFunction:(id)guest_arg0 file:(id)guest_arg1 lineNumber:(int)guest_arg2 description:(id)guest_arg3 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
