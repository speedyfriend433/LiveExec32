...
+ (id)credentialWithUser:(id)guest_arg0 password:(id)guest_arg1 persistence:(unsigned int)guest_arg2 {
...
+ (id)credentialForTrust:(__SecTrust *)guest_arg0 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  /* declaration: unhandled type __SecTrust * */ 
  uint64_t host_ret = LC32InvokeHostSelector(self.host_self, _host_cmd, /* parameterToBePassed: unhandled type __SecTrust * */);
  /* postCall: unhandled type __SecTrust * */ 
  return LC32HostToGuestObject(host_ret);
}
#endif
...
#if 0 // FIXME: has unhandled types
- (id)initWithIdentity:(__SecIdentity *)guest_arg0 certificates:(id)guest_arg1 persistence:(unsigned int)guest_arg2 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  /* declaration: unhandled type __SecIdentity * */ 
  uint64_t host_arg1 = [guest_arg1 host_self]; 
  uint64_t host_arg2 = (uint64_t)guest_arg2; 
  uint64_t host_ret = LC32InvokeHostSelector(self.host_self, _host_cmd, /* parameterToBePassed: unhandled type __SecIdentity * */, host_arg1, host_arg2);
  /* postCall: unhandled type __SecIdentity * */ 
  // No post-process for guest_arg1 
  // No post-process for guest_arg2 
...
#if 0 // FIXME: has unhandled types
- (id)initWithTrust:(__SecTrust *)guest_arg0 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  /* declaration: unhandled type __SecTrust * */ 
...
- (__SecIdentity *)identity {
  ...
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_ret = LC32InvokeHostSelector(self.host_self, _host_cmd);
  /* returnLine: unhandled type __SecIdentity * */
}
#endif
...
- (id)initWithUser:(id)guest_arg0 password:(id)guest_arg1 persistence:(unsigned int)guest_arg2 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_arg0 = [guest_arg0 host_self]; 
...
#if 0 // FIXME: has unhandled types
+ (id)credentialWithIdentity:(__SecIdentity *)guest_arg0 certificates:(id)guest_arg1 persistence:(unsigned int)guest_arg2 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  /* declaration: unhandled type __SecIdentity * */ 
