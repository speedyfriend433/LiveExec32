...
- (id)initWithSource:(id)guest_arg0 newVersion:(unsigned int)guest_arg1 oldVersion:(unsigned int)guest_arg2 snapshot1:(id)guest_arg3 snapshot2:(id)guest_arg4 snapshot3:(id)guest_arg5 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
...
- (id)initWithSource:(id)guest_arg0 newVersion:(unsigned int)guest_arg1 oldVersion:(unsigned int)guest_arg2 cachedSnapshot:(id)guest_arg3 persistedSnapshot:(id)guest_arg4 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_arg0 = [guest_arg0 host_self]; 
