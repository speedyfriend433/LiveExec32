...
- (id)initWithConstraint:(id)guest_arg0 databaseObject:(id)guest_arg1 databaseSnapshot:(id)guest_arg2 conflictingObjects:(id)guest_arg3 conflictingSnapshots:(id)guest_arg4 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
