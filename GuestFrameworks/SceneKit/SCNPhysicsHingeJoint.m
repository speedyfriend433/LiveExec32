...
- (void)setAxisB:(SCNVector3)guest_arg0 {
...
#if 0 // FIXME: has unhandled types
+ (id)jointWithBody:(id)guest_arg0 axis:(SCNVector3)guest_arg1 anchor:(SCNVector3)guest_arg2 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_arg0 = [guest_arg0 host_self]; 
  /* declaration: unhandled type SCNVector3 */ 
  /* declaration: unhandled type SCNVector3 */ 
  uint64_t host_ret = LC32InvokeHostSelector(self.host_self, _host_cmd, host_arg0, /* parameterToBePassed: unhandled type SCNVector3 */, /* parameterToBePassed: unhandled type SCNVector3 */);
  // No post-process for guest_arg0 
...
#if 0 // FIXME: has unhandled types
- (id)initWithBody:(id)guest_arg0 axis:(SCNVector3)guest_arg1 anchor:(SCNVector3)guest_arg2 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_arg0 = [guest_arg0 host_self]; 
...
#if 0 // FIXME: has unhandled types
- (void)setAxisA:(SCNVector3)guest_arg0 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  /* declaration: unhandled type SCNVector3 */ 
...
#if 0 // FIXME: has unhandled types
- (id)initWithBodyA:(id)guest_arg0 axisA:(SCNVector3)guest_arg1 anchorA:(SCNVector3)guest_arg2 bodyB:(id)guest_arg3 axisB:(SCNVector3)guest_arg4 anchorB:(SCNVector3)guest_arg5 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_arg0 = [guest_arg0 host_self]; 
  ...
  /* declaration: unhandled type SCNVector3 */ 
  /* declaration: unhandled type SCNVector3 */ 
  uint64_t host_ret = LC32InvokeHostSelector(self.host_self, _host_cmd, host_arg0, /* parameterToBePassed: unhandled type SCNVector3 */, /* parameterToBePassed: unhandled type SCNVector3 */, host_arg3, /* parameterToBePassed: unhandled type SCNVector3 */, /* parameterToBePassed: unhandled type SCNVector3 */);
  // No post-process for guest_arg0 
  // No post-process for guest_arg1 
  // No post-process for guest_arg2 
...
#if 0 // FIXME: has unhandled types
+ (id)jointWithBodyA:(id)guest_arg0 axisA:(SCNVector3)guest_arg1 anchorA:(SCNVector3)guest_arg2 bodyB:(id)guest_arg3 axisB:(SCNVector3)guest_arg4 anchorB:(SCNVector3)guest_arg5 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_arg0 = [guest_arg0 host_self]; 
