...
- (id)initWithAuthorizationStatus:(int)guest_arg0 soundSetting:(int)guest_arg1 badgeSetting:(int)guest_arg2 alertSetting:(int)guest_arg3 notificationCenterSetting:(int)guest_arg4 lockScreenSetting:(int)guest_arg5 carPlaySetting:(int)guest_arg6 alertStyle:(int)guest_arg7 {
...
+ (id)settingsWithAuthorizationStatus:(int)guest_arg0 soundSetting:(int)guest_arg1 badgeSetting:(int)guest_arg2 alertSetting:(int)guest_arg3 notificationCenterSetting:(int)guest_arg4 lockScreenSetting:(int)guest_arg5 carPlaySetting:(int)guest_arg6 alertStyle:(int)guest_arg7 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_arg0 = (uint64_t)guest_arg0; 
