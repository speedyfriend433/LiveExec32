...
+ (id)categoryWithIdentifier:(id)guest_arg0 actions:(id)guest_arg1 intentIdentifiers:(id)guest_arg2 options:(unsigned int)guest_arg3 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_arg0 = [guest_arg0 host_self]; 
...
+ (id)categoryWithIdentifier:(id)guest_arg0 actions:(id)guest_arg1 minimalActions:(id)guest_arg2 intentIdentifiers:(id)guest_arg3 options:(unsigned int)guest_arg4 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_arg0 = [guest_arg0 host_self]; 
