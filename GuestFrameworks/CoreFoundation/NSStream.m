...
+ (void)getStreamsToHost:(id)guest_arg0 port:(int)guest_arg1 inputStream:(id *)guest_arg2 outputStream:(id *)guest_arg3 {
...
- (char)setProperty:(id)guest_arg0 forKey:(id)guest_arg1 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_arg0 = [guest_arg0 host_self]; 
...
+ (void)getBoundStreamsWithBufferSize:(unsigned int)guest_arg0 inputStream:(id *)guest_arg1 outputStream:(id *)guest_arg2 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
...
+ (void)getStreamsToHostWithName:(id)guest_arg0 port:(int)guest_arg1 inputStream:(id *)guest_arg2 outputStream:(id *)guest_arg3 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  uint64_t host_arg0 = [guest_arg0 host_self]; 
