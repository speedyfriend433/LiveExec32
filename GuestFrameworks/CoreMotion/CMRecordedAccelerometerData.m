...
- (void)resetWithData:(CMAccel100 *)guest_arg0 timestamp:(uint64_t)guest_arg1 walltime:(double)guest_arg2 identifier:(uint64_t)guest_arg3 {
  ...
  /* declaration: unhandled type CMAccel100 * */ 
  uint64_t host_arg1 = (uint64_t)guest_arg1; 
  double host_arg2 = (double)guest_arg2; 
  uint64_t host_arg3 = (uint64_t)guest_arg3; 
  uint64_t host_ret = LC32InvokeHostSelector(self.host_self, _host_cmd, /* parameterToBePassed: unhandled type CMAccel100 * */, host_arg1, host_arg2, host_arg3);
  /* postCall: unhandled type CMAccel100 * */ 
...
#if 0 // FIXME: has unhandled types
- (id)initWithData:(CMAccel100 *)guest_arg0 timestamp:(uint64_t)guest_arg1 walltime:(double)guest_arg2 identifier:(uint64_t)guest_arg3 {
  printf("DBG: call [%s %s]\n", class_getName(self.class), sel_getName(_cmd));
  static uint64_t _host_cmd;
  if(!_host_cmd) _host_cmd = LC32GetHostSelector(_cmd) | (uint64_t)0 << 63;
  /* declaration: unhandled type CMAccel100 * */ 
