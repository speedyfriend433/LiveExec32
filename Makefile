...
LiveExec32_FILES = main.cpp arm_dynarmic_cp15.cpp dynarmic.cpp filesystem.cpp ap_getparents.c
LiveExec32_CFLAGS = -fobjc-arc -Iinclude -DDYNARMIC_MASTER -Wno-error
